...
@stop
@section('description')
    Все монеты / криптовалюты которые добываются асиками или являются востребованными криптоэнтузиастами. Если вы нашли неточности - вы всегда можете предложить изменения через соответствующую форму
@stop
