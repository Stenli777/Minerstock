...
@stop
@section('description')
        Все ASIC майнеры, которые было произведены собраны в одном месте. Если вы нашли неточности - вы всегда можете предложить изменения через соответствующую форму
@stop
