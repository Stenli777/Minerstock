 ...
 * Class PartnerLinks
 *
 * @property \App\Models\PartnerLink $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class PartnerLinks extends Section implements Initializable
{
    /**
     * @var bool
     */
    ...
    public function onDisplay($payload = [])
    {
        $columns = [
            ...
            AdminColumn::text('name', 'Название ссылки'),
            AdminColumn::text('entity', 'Категория объекта'),
            AdminColumn::text('id_entity', 'ID объекта'),
        ...
        $display->setColumnFilters([
            AdminColumnFilter::select()
                ->setModelForOptions(\App\Models\PartnerLink::class, 'name')
